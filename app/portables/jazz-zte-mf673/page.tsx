...
export default function JazzMf673Page() {
  const product = {
    name: "Jazz ZTE MF673 4G LTE Unlocked Portable WiFi Device (PTA Approved)",
    price: "Rs. 5,299",
    shortTag: "Compact 4G Hotspot Device for Travel, CCTV & Daily Use",
    descriptionShort:
      "The Jazz ZTE MF673 is a compact and reliable 4G portable WiFi device designed for users on the go. It supports up to 10 devices simultaneously and offers stable, high‑speed internet – ideal for travel, CCTV setups and hotspot sharing.",
    keyFeatures: [
      "Supports up to 10 connected devices at once.",
      "4G LTE high‑speed internet connectivity.",
      "Works as WiFi hotspot and via USB connection.",
      "Strong and stable WiFi signal range.",
      "PTA approved and factory unlocked (all networks supported).",
      "Comes with new box‑packed battery.",
    ],
    bodyText:
      "The Jazz ZTE MF673 4G LTE portable device is an excellent solution for users who need reliable internet anywhere. Its compact design makes it perfect for traveling, while its powerful performance ensures smooth connectivity for professionals and CCTV systems. With support for up to 10 devices, it allows multiple users to stay connected without speed drops. The device can be used both wirelessly and through USB, offering flexibility for laptops and PCs. It is PTA approved and unlocked, meaning you can use any SIM card in Pakistan without restrictions. The package includes the device along with a new box‑packed battery, ensuring long‑lasting usage and portability.",
    gallery: [
      {
        src: "/portables/mf673-1.jpg",
        alt: "Jazz ZTE MF673 portable WiFi device",
      },
      { src: "/portables/mf673-2.jpg", alt: "Jazz ZTE MF673 device and box" },
      { src: "/portables/mf673-3.jpg", alt: "Jazz ZTE MF673 in hand" },
    ] as GalleryImage[],
  };
