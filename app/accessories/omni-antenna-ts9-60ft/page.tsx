...
export default function OmniTs9Page() {
  const product = {
    name: "Outdoor 4G/5G Omnidirectional Antenna with TS‑9 Connector (60ft Cable)",
    price: "Rs. 3,000",
    shortTag:
      "External Antenna for Portable Devices & Routers (TS‑9 Connector)",
    descriptionShort:
      "Enhance your device’s signal strength with this 4G/5G outdoor antenna featuring a TS‑9 connector and 60ft cable. Perfect for antenna‑supported portable devices and some routers.",
    keyFeatures: [
      "Compatible with TS‑9 supported devices and routers.",
      "Supports both 4G LTE and 5G signals.",
      "60ft cable for flexible outdoor installation.",
      "Omnidirectional design for maximum signal capture.",
      "Waterproof and durable for outdoor use.",
      "Easy plug‑and‑play setup.",
    ],
    bodyText:
      "The outdoor omnidirectional antenna with TS‑9 connector is an ideal solution for improving signal strength in portable devices and supported routers. It is specially designed for users facing weak network coverage, offering enhanced reception and faster internet speeds. With support for both 4G and 5G networks, it ensures stable connectivity for streaming, browsing, and professional use. The 60ft cable allows easy placement in optimal outdoor locations, maximizing signal performance. Its waterproof construction ensures durability in all weather conditions, making it suitable for long‑term use.",
    gallery: [
      { src: "/accessories/ts9-1.jpg", alt: "Outdoor TS‑9 4G/5G antenna" },
      {
        src: "/accessories/ts9-2.jpg",
        alt: "TS‑9 antenna packaging and cable",
      },
      {
        src: "/accessories/ts9-3.jpg",
        alt: "TS‑9 antenna cable coiled",
      },
    ] as GalleryImage[],
  };
