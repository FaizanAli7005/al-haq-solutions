...
export default function OmniSmaPage() {
  const product = {
    name: "Outdoor 4G/5G Omnidirectional Antenna with SMA Connector (60ft Cable)",
    price: "Rs. 3,000",
    shortTag:
      "Long‑Range Signal Booster Antenna for Routers (SMA Connector)",
    descriptionShort:
      "Boost your internet signal with this outdoor omnidirectional 4G/5G antenna featuring a 60ft cable and SMA connector. Designed for SIM routers, it improves signal strength and stability in weak coverage areas.",
    keyFeatures: [
      "Supports 4G LTE and 5G networks.",
      "60ft long cable for flexible outdoor placement.",
      "SMA RF coaxial connector for wide router compatibility.",
      "Omnidirectional design for 360° signal reception.",
      "Waterproof and weather‑resistant build.",
      "Plug‑and‑play with easy installation.",
    ],
    bodyText:
      "This outdoor omnidirectional antenna is designed to significantly enhance your internet signal reception in low coverage areas. Supporting both 4G LTE and 5G networks, it ensures faster speeds and more stable connectivity for your SIM routers. The included 60ft cable allows flexible placement for optimal signal capture, even on rooftops or outside walls. Its SMA connector ensures compatibility with a wide range of routers, making it a versatile choice for home and office setups. Built with a waterproof and durable design, it performs reliably in all weather conditions. With simple plug‑and‑play installation, it is an ideal solution for users looking to improve their network performance effortlessly.",
    gallery: [
      { src: "/accessories/sma-1.jpg", alt: "Outdoor SMA 4G/5G antenna" },
      {
        src: "/accessories/sma-2.jpg",
        alt: "SMA antenna with mount and hardware",
      },
      {
        src: "/accessories/sma-3.jpg",
        alt: "SMA antenna with cable on table",
      },
    ] as GalleryImage[],
  };
